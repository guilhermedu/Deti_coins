...
#define MD5_OP_V8SI(F,a,b,c,d,x,s,ac)  a += (v8si)(F(b,c,d) + x + C(ac)); if(s != 0) a = ROTATE(a,s); a += b

#define CUSTOM_MD5_CODE_V8SI()                           \
  do                                                     \
  {                                                      \
    /* initial state */                                  \
    STATE(0) = C(0x67452301u);                           \
    ...
    X(15) = C(0x00000000u); /* of bits */                \
    /* first round */                                    \
    MD5_OP_V8SI(MD5_F,a,b,c,d,X( 0),MD5_11,0xD76AA478u); \
    MD5_OP_V8SI(MD5_F,d,a,b,c,X( 1),MD5_12,0xE8C7B756u); \
    MD5_OP_V8SI(MD5_F,c,d,a,b,X( 2),MD5_13,0x242070DBu); \
    MD5_OP_V8SI(MD5_F,b,c,d,a,X( 3),MD5_14,0xC1BDCEEEu); \
    MD5_OP_V8SI(MD5_F,a,b,c,d,X( 4),MD5_11,0xF57C0FAFu); \
    MD5_OP_V8SI(MD5_F,d,a,b,c,X( 5),MD5_12,0x4787C62Au); \
    MD5_OP_V8SI(MD5_F,c,d,a,b,X( 6),MD5_13,0xA8304613u); \
    MD5_OP_V8SI(MD5_F,b,c,d,a,X( 7),MD5_14,0xFD469501u); \
    MD5_OP_V8SI(MD5_F,a,b,c,d,X( 8),MD5_11,0x698098D8u); \
    MD5_OP_V8SI(MD5_F,d,a,b,c,X( 9),MD5_12,0x8B44F7AFu); \
    MD5_OP_V8SI(MD5_F,c,d,a,b,X(10),MD5_13,0xFFFF5BB1u); \
    MD5_OP_V8SI(MD5_F,b,c,d,a,X(11),MD5_14,0x895CD7BEu); \
    MD5_OP_V8SI(MD5_F,a,b,c,d,X(12),MD5_11,0x6B901122u); \
    MD5_OP_V8SI(MD5_F,d,a,b,c,X(13),MD5_12,0xFD987193u); \
    MD5_OP_V8SI(MD5_F,c,d,a,b,X(14),MD5_13,0xA679438Eu); \
    MD5_OP_V8SI(MD5_F,b,c,d,a,X(15),MD5_14,0x49B40821u); \
    /* second round */                                   \
    MD5_OP_V8SI(MD5_G,a,b,c,d,X( 1),MD5_21,0xF61E2562u); \
    MD5_OP_V8SI(MD5_G,d,a,b,c,X( 6),MD5_22,0xC040B340u); \
    MD5_OP_V8SI(MD5_G,c,d,a,b,X(11),MD5_23,0x265E5A51u); \
    MD5_OP_V8SI(MD5_G,b,c,d,a,X( 0),MD5_24,0xE9B6C7AAu); \
    MD5_OP_V8SI(MD5_G,a,b,c,d,X( 5),MD5_21,0xD62F105Du); \
    MD5_OP_V8SI(MD5_G,d,a,b,c,X(10),MD5_22,0x02441453u); \
    MD5_OP_V8SI(MD5_G,c,d,a,b,X(15),MD5_23,0xD8A1E681u); \
    MD5_OP_V8SI(MD5_G,b,c,d,a,X( 4),MD5_24,0xE7D3FBC8u); \
    MD5_OP_V8SI(MD5_G,a,b,c,d,X( 9),MD5_21,0x21E1CDE6u); \
    MD5_OP_V8SI(MD5_G,d,a,b,c,X(14),MD5_22,0xC33707D6u); \
    MD5_OP_V8SI(MD5_G,c,d,a,b,X( 3),MD5_23,0xF4D50D87u); \
    MD5_OP_V8SI(MD5_G,b,c,d,a,X( 8),MD5_24,0x455A14EDu); \
    MD5_OP_V8SI(MD5_G,a,b,c,d,X(13),MD5_21,0xA9E3E905u); \
    MD5_OP_V8SI(MD5_G,d,a,b,c,X( 2),MD5_22,0xFCEFA3F8u); \
    MD5_OP_V8SI(MD5_G,c,d,a,b,X( 7),MD5_23,0x676F02D9u); \
    MD5_OP_V8SI(MD5_G,b,c,d,a,X(12),MD5_24,0x8D2A4C8Au); \
    /* third round */                                    \
    MD5_OP_V8SI(MD5_H,a,b,c,d,X( 5),MD5_31,0xFFFA3942u); \
    MD5_OP_V8SI(MD5_H,d,a,b,c,X( 8),MD5_32,0x8771F681u); \
    MD5_OP_V8SI(MD5_H,c,d,a,b,X(11),MD5_33,0x6D9D6122u); \
    MD5_OP_V8SI(MD5_H,b,c,d,a,X(14),MD5_34,0xFDE5380Cu); \
    MD5_OP_V8SI(MD5_H,a,b,c,d,X( 1),MD5_31,0xA4BEEA44u); \
    MD5_OP_V8SI(MD5_H,d,a,b,c,X( 4),MD5_32,0x4BDECFA9u); \
    MD5_OP_V8SI(MD5_H,c,d,a,b,X( 7),MD5_33,0xF6BB4B60u); \
    MD5_OP_V8SI(MD5_H,b,c,d,a,X(10),MD5_34,0xBEBFBC70u); \
    MD5_OP_V8SI(MD5_H,a,b,c,d,X(13),MD5_31,0x289B7EC6u); \
    MD5_OP_V8SI(MD5_H,d,a,b,c,X( 0),MD5_32,0xEAA127FAu); \
    MD5_OP_V8SI(MD5_H,c,d,a,b,X( 3),MD5_33,0xD4EF3085u); \
    MD5_OP_V8SI(MD5_H,b,c,d,a,X( 6),MD5_34,0x04881D05u); \
    MD5_OP_V8SI(MD5_H,a,b,c,d,X( 9),MD5_31,0xD9D4D039u); \
    MD5_OP_V8SI(MD5_H,d,a,b,c,X(12),MD5_32,0xE6DB99E5u); \
    MD5_OP_V8SI(MD5_H,c,d,a,b,X(15),MD5_33,0x1FA27CF8u); \
    MD5_OP_V8SI(MD5_H,b,c,d,a,X( 2),MD5_34,0xC4AC5665u); \
    /* fourth round */                                   \
    MD5_OP_V8SI(MD5_I,a,b,c,d,X( 0),MD5_41,0xF4292244u); \
    MD5_OP_V8SI(MD5_I,d,a,b,c,X( 7),MD5_42,0x432AFF97u); \
    MD5_OP_V8SI(MD5_I,c,d,a,b,X(14),MD5_43,0xAB9423A7u); \
    MD5_OP_V8SI(MD5_I,b,c,d,a,X( 5),MD5_44,0xFC93A039u); \
    MD5_OP_V8SI(MD5_I,a,b,c,d,X(12),MD5_41,0x655B59C3u); \
    MD5_OP_V8SI(MD5_I,d,a,b,c,X( 3),MD5_42,0x8F0CCC92u); \
    MD5_OP_V8SI(MD5_I,c,d,a,b,X(10),MD5_43,0xFFEFF47Du); \
    MD5_OP_V8SI(MD5_I,b,c,d,a,X( 1),MD5_44,0x85845DD1u); \
    MD5_OP_V8SI(MD5_I,a,b,c,d,X( 8),MD5_41,0x6FA87E4Fu); \
    MD5_OP_V8SI(MD5_I,d,a,b,c,X(15),MD5_42,0xFE2CE6E0u); \
    MD5_OP_V8SI(MD5_I,c,d,a,b,X( 6),MD5_43,0xA3014314u); \
    MD5_OP_V8SI(MD5_I,b,c,d,a,X(13),MD5_44,0x4E0811A1u); \
    MD5_OP_V8SI(MD5_I,a,b,c,d,X( 4),MD5_41,0xF7537E82u); \
    MD5_OP_V8SI(MD5_I,d,a,b,c,X(11),MD5_42,0xBD3AF235u); \
    MD5_OP_V8SI(MD5_I,c,d,a,b,X( 2),MD5_43,0x2AD7D2BBu); \
    MD5_OP_V8SI(MD5_I,b,c,d,a,X( 9),MD5_44,0xEB86D391u); \
    /* update state */                                   \
    STATE(0) += a;                                       \
    STATE(1) += b;                                       \
    STATE(2) += c;                                       \
